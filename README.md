...
[![Build Status](https://api.travis-ci.com/dereuromark/cakephp-ide-helper.svg?branch=master)](https://travis-ci.com/dereuromark/cakephp-ide-helper)
...
- [Migrations](https://github.com/cakephp/migrations) for migration file writing (included in IdeHelper directy).
